...
#endif
        LDMFD   sp!, {v1,v2,v3,v4,v5,v6,pc}RETF
...
LABEL(copy_loop_up_l1)
        ...
        RETC(EQ)                /* if zero then we're done */
...
LABEL(copy_loop_up_l2)
        ...
        LDMFD   sp!,{v1,pc}RETF   /* restore work regs and return */
...
LABEL(or_loop_up_l2)
        ...
        LDMFD   sp!,{v1-v5,pc}RETF /* restore work regs and return */
...
LABEL(not_loop_up_l2)
        ...
        LDMFD   sp!,{pc}RETF /* restore work regs and return */
...
LABEL(and_test_loop_up_l2)
        ...
        TSTEQ   v5,v2
        TSTEQ   lr,ip
        LDMNEFD sp!,{v1-v6,pc}RETF
        SUBS    a4,a4,#4            /* decrement counter by 4 */
        BGT     and_test_loop_up_l2 /* if count still positive then loop */
        MOV     a1,#0
        LDMFD   sp!,{v1-v6,pc}RETF /* restore work regs and return */
...
GLABEL(test_loop_up)
        ...
        RETC(NE)                /* return true if AND_TEST ok */
        CMP     a3,#2
...
GLABEL(compare_loop_up)
        ...
        MVNLO   a1,#0           /* x < y -> -1 */
        MOVHI   a1,#1           /* x > y -> +1 */
        RETC(NE)                /* and return result if not equal */
        ANDS    a4,a3,#3
        CMP     a4,#2
...
LABEL(inc_loop_down_l1)
        ...
        RETC(NE)                /* return 0 if any result non-zero */
...
LABEL(inc_loop_down_l2)
        ...
        LDMNEFD sp!,{v1,pc}RETF   /* return 0 if any result non-zero */
        SUBS    a4,a4,#4          /* decrement counter by 4 */
        BGT     inc_loop_down_l2 /* if count still positive then loop */
        MOV     a1,#1
        LDMFD   sp!,{v1,pc}RETF /* restore work regs and return 1 */
...
LABEL(sub_loop_down_l4)     /* drop through for better instr. timings */
        ...
        LDMEQFD sp!,{v6,pc}RETF  /* and return */
        STMFD   sp!,{v1-v5}      /* save work regs */
...
GLABEL(dec_loop_down)
        ...
        RETC(CS)                /* return 0 if non-zero result */
LABEL(dec_loop_down_l1)
        ...
        STMDB   ip!,{a2,a3}     /* store 2 results */
        RETC(CS)                /* return 0 if any result non-zero */
        SUBS    a4,a4,#2        /* decrement counter by 2 */
...
LABEL(dec_loop_down_l2)
        ...
        SUBCCS  a2,a2,#1
        STMDB   ip!,{a2,a3,v1,lr} /* store 4 results */
        LDMCSFD sp!,{v1,pc}RETF   /* return 0 if any carry */
        SUBS    a4,a4,#4          /* decrement counter by 4 */
...
LABEL(neg_loop_down_l4)
        ...
        LDMFD   sp!,{pc}RETF     /* restore work regs and return -1 */
...
LABEL(shiftleft_loop_down_l1)
        ...
        LDMEQFD sp!,{v6,pc}RETF /* so return last shift out */
...
LABEL(shiftleft_loop_down_l2)
        ...
        LDMFD   sp!,{v1-v3,v6,pc}RETF /* restore work regs and return */
...
LABEL(shiftleftcopy_loop_down_l1)
        ...
        LDMEQFD sp!,{v5,v6,pc}RETF /* so return last shift out */
        STMFD   sp!,{v1-v3}     /* save work regs */
LABEL(shiftleftcopy_loop_down_l2)
        ...
        LDMFD   sp!,{v1-v3,v5,v6,pc}RETF /* restore work regs and return */
